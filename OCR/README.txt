...
* https://adeshpande3.github.io/A-Beginner's-Guide-To-Understanding-Convolutional-Neural-Networks/ - CNN basics
* https://developer.nvidia.com/digits - For those who want to dive in CUDA CNN
* https://github.com/synckey/tensorflow_lstm_ctc_ocr - Example CNN for digit recognition using Python
* http://www.robots.ox.ac.uk/~vgg/data/text - Synthetic word and character datasets
* https://www.tensorflow.org/ - Tensorflow framework
* https://opencv.org/ - OpenCV library
* https://keras.io/ - Keras API
* https://github.com/tesseract-ocr/tesseract - Tesseract OCR repository