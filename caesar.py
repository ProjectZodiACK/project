...
class English():
	...
	def loadDictionary(self):
		try:
			# hardcoded the dictionary file
			file = open('dictionary10000.txt','r')
			words={}
...
# changed original code to accept a cipher argument so it can be called from the main code process
def main(cipher):
