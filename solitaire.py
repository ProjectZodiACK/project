...
parser.add_argument('-c', '--cipher', type=str, help='the ciphertext')
...
def gen_keystream_letters(deck, CIPHER):
...
def main(CIPHER):
	...
	KEY_STREAM = gen_keystream_letters(DECK, CIPHER)
	...
	return("Solitaire Cipher Results: {}".format(convert_number_to_test(plain)))
